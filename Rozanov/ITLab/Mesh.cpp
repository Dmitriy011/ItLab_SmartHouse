...
void Mesh::Draw(Shader& shader)
{
    ...
    for (unsigned int i = 0; i < textures.size(); i++)
    {
        ...
        {    
            number = std::to_string(diffuseNr++);                                                   // Узнаем колличество diffuse текстуры, ...
        }
        else 
        {
