...
def bathroom_update_light_auto(input_value):
    if input_value=='1':
...
def bathroom_update_lamp1(input_value, n_intervals):
    ctx = dash.callback_context

    if ctx.triggered[0]['prop_id'].split('.')[0] == "interval-component":
        n = client.lamp_select("bath/lamp1")["power"]
        ...
        if input_value != None:
            ...
            n = client.lamp_select("bath/lamp1")["power"]
            client.lamp_upsert("bath/lamp1", n, False)
...
def bathroom_update_lamp2(input_value, n_intervals):
    ctx = dash.callback_context

    if ctx.triggered[0]['prop_id'].split('.')[0] == "interval-component":
        n = client.lamp_select("bath/lamp2")["power"]
        print("Интервал", n_intervals)
    else:
        if input_value!=None:
            ...
            n=client.lamp_select("bath/lamp2")["power"]
            client.lamp_upsert("bath/lamp2",n,False)
    return 'Текущая яркость лампы: {}'.format(n)
...
def bathroom_update_lamp3(input_value, n_intervals):
    ctx = dash.callback_context

    if ctx.triggered[0]['prop_id'].split('.')[0] == "interval-component":
        n = client.lamp_select("bath/lamp3")["power"]
        print("Интервал", n_intervals)
    else:
        if input_value!=None:
            ...
            n=client.lamp_select("bath/lamp3")["power"]
            client.lamp_upsert("bath/lamp3",n,False)
    return 'Текущая яркость лампы: {}'.format(n)
...
def bathroom_update_jalousie(input_value, n_intervals):
    ctx = dash.callback_context

    if ctx.triggered[0]['prop_id'].split('.')[0] == "interval-component":
        n = client.jalousie_select("bath/jalousie")["rotation"]
        print("Интервал", n_intervals)
    else:
        if input_value!=None:
            ...
            n=client.jalousie_select("bath/jalousie")["rotation"]
            client.jalousie_upsert("bath/jalousie",n,False)
...
def bathroom_update_battery_auto(input_value):
    if input_value=='1':
...
def bathroom_update_battery(input_value, n_intervals):
    ctx = dash.callback_context

    if ctx.triggered[0]['prop_id'].split('.')[0] == "interval-component":
        n = client.heater_select("bath/heater")["warmth"]
        print("Интервал", n_intervals)
    else:
        if input_value!=None:
            ...
            n=client.heater_select("bath/heater")["warmth"]
            client.heater_upsert("bath/heater",n,False)
